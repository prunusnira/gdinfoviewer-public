...
class WidgetProviderType1 : AppWidgetProvider() {
    ...
    override fun onUpdate(context: Context, appWidgetManager: AppWidgetManager, appWidgetIds: IntArray) {
        val widget = ComponentName(context, WidgetProviderType1::class.java)
        val view = RemoteViews(context.packageName, R.layout.widget_skill_type1)
    ...
    override fun onReceive(context: Context, intent: Intent) {
        ...
        if (action == Const.WIDGET_UPDATE) {
            ...
            view.setTextViewText(R.id.widget_gskill, "GF " + pref.getString("gskill", "")!!)
            view.setTextViewText(R.id.widget_dskill, "DM " + pref.getString("dskill", "")!!)
